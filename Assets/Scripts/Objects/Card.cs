...
public class Card : MonoBehaviour
{
    ...
    private UICard _canvasCard;

    private void Start()
    {
        _rigidbody = GetComponent<Rigidbody>();
        _canvasCard = GetComponent<UICard>();
    ...
    {
        _canvasCard.SetAllCardData(gameData);
    }
    ...
    private IEnumerator PopCardEffect()
    {
        ...
        StartCoroutine(_canvasCard.SetAllCardData(ApiRawgManager.Instance.GetGame()));
